...
- (void)viewDidLoad {
    ...
    [self animateRadarRotation];
}


#pragma mark - Private interface

- (void)animateRadarRotation {
    [UIView animateWithDuration:1 delay:0 options:UIViewAnimationOptionCurveLinear animations:^{
        [self.radarImageView setTransform:CGAffineTransformRotate(self.radarImageView.transform, M_PI_2)];
...
//    MKAnnotationView *pinView = (MKAnnotationView *)[mapView dequeueReusableAnnotationViewWithIdentifier:pinIdStr];
//    if (!pinView) {
//        pinView = [[MKAnnotationView alloc] initWithAnnotation:annotation reuseIdentifier:pinIdStr];
